    ...
    switch (grooveType) {
        ...
        case 'DiamondGroove':
            return {
                ...
                rule: 'Exactly two additional parameters must be set.'
            };
        case 'GothicGroove':
            return {
                required: [
        ...
        case 'SquareGroove':
            return {
                ...
                rule: 'Exactly two of the additional parameters must be set.'
            };
        ...
        case 'FalseRoundGroove':
            return {
                ...
                rule: 'Exactly two of R2, Depth or Usable Width must be set. One of Flank Angle, Width, Height or Length must be set.'
            };
        case 'FlatGroove':
            return {
                required: [
